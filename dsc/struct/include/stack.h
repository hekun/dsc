...
typedef Status  StackTraverse(STACK_T stack, opt_visit vist);
...
Status  RegisterStackFuncs(Stack_funcs_t *funcs,stack_type_t type, stack_opt_funcs_t *ofunc);
void    LogoutStackFuncs(Stack_funcs_t *funcs);
